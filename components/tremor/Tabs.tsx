...
function getVariantStyles(tabVariant: TabsListVariant) {
  switch (tabVariant) {
    ...
    case "solid":
      return cx(
        // base
        "inline-flex items-center justify-center rounded-sm px-3 py-3 text-sm font-medium whitespace-nowrap ring-1 transition-all ring-inset",
        // text color
        ...
        "ring-transparent",
        // selected
        "data-[state=active]:bg-[#F06AA8] data-[state=active]:text-white data-[state=active]:shadow-sm",
